...
/* harmony import */ var _modules_showContent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/showContent */ "./src/js/modules/showContent.js");
...
/* harmony import */ var _modules_photosEvent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/photosEvent */ "./src/js/modules/photosEvent.js");
/* harmony import */ var _modules_hint__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/hint */ "./src/js/modules/hint.js");
...
/* harmony import */ var _modules_drag__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_modules_drag__WEBPACK_IMPORTED_MODULE_12__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showContent__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_5__["default"])();
  ...
  Object(_modules_photosEvent__WEBPACK_IMPORTED_MODULE_8__["default"])({
    sizeBlock: '.sizes-wrapper',
    imagies: 'img'
  });
  Object(_modules_hint__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_11__["default"])();
  _modules_drag__WEBPACK_IMPORTED_MODULE_12___default()();
});
...
var burger = function burger() {
  ...
  var showMenuOnWidth = function showMenuOnWidth() {
...
var calc = function calc(_ref) {
  var size = _ref.size,
      ...
      price = _ref.price;
  var calcSize = document.getElementById(size),
...
var filter = function filter(_ref) {
  var btns = _ref.btns,
      photos = _ref.photos,
      sharp = _ref.sharp;
  var portfolioMenu = document.querySelector(btns),
      portfolioBlock = document.querySelectorAll(photos),
      portfolioNo = document.querySelector(sharp);

  var hideActivClass = function hideActivClass() {
    portfolioMenu.children.forEach(function (item) {
      item.classList.remove('active');
    });
  };

  var filterElems = function filterElems(e) {
    var target = e.target;
    var arr = [];
    hideActivClass();
    portfolioBlock.forEach(function (item) {
      item.style.display = 'none';
      item.classList.forEach(function (elem) {
...
/* harmony import */ var _services_post__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/post */ "./src/js/modules/services/post.js");
...
var form = function form() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('change', function (e) {
      ...
      if (fileName[0].length >= 6) {
        item.previousElementSibling.textContent = fileName[0].slice(0, 6) + '...' + fileName[1];
      } else {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_post__WEBPACK_IMPORTED_MODULE_7__["postData"])(formData, API).then(function (data) {
        console.log(data);
        img.src = message.ok;
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(btnSelector, modalSelector, closeBtn) {
    ...
    var timeOutModal = function timeOutModal(selector, time) {
      var display = false;
      setTimeout(function () {
  ...
  var getModalOnScroll = function getModalOnScroll() {
    window.addEventListener('scroll', function () {
...
var photosEvent = function photosEvent(_ref) {
  var sizeBlock = _ref.sizeBlock,
      imagies = _ref.imagies;
  var sizesBlock = document.querySelector(sizeBlock),
      img = sizesBlock.querySelectorAll(imagies);

  var showImg = function showImg(e) {
    var target = e.target;

    if (target.tagName === 'IMG') {
      target.src = target.src.slice(0, -4) + '-1.png';
      target.parentElement.querySelectorAll('p').forEach(function (elem) {
  ...
  var hideImg = function hideImg(e) {
    var target = e.target;
...
/* harmony default export */ __webpack_exports__["default"] = (photosEvent);
...
var scroll = function scroll() {
  var stylesBtn = document.querySelectorAll('[href="#styles"]'),
  ...
  var getScroll = function getScroll(btn, scrollSelector) {
    btn.forEach(function (item) {
      item.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw Error("Error log: ".concat(res, ", status: ").concat(res.status));
...
/* harmony import */ var _services_post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/post */ "./src/js/modules/services/post.js");
...
var showContent = function showContent() {
  var buttonStyles = document.querySelector('.button-styles');

  var getContent = function getContent() {
    Object(_services_post__WEBPACK_IMPORTED_MODULE_3__["getData"])('http://localhost:3000/styles').then(function (res) {
      createCards(res);
    });
...
var slider = function slider() {
  ...
  mainSlider.style.cssText = "\n\t\theight: ".concat(heightImg, "px;\n\t\toverflow: hidden;\n\t");

  var showSlider = function showSlider() {
  ...
  var counter = 1;
  var offsetWidth = 0;
  feedbackSlideritem.forEach(function (item) {
  ...
  var prevSlide = function prevSlide() {
    counter > 1 ? offsetWidth += widthImg : (offsetWidth = (feedbackSlideritem.length - 1) * -widthImg, counter = feedbackSlideritem.length + 1);
    showSlides();
    counter--;
  };
  ...
  slideInterval();
  feedbackSlideritem.forEach(function (element) {
